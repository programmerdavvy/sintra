...
function Login() {
  ...
  return (
    <>
      ...
      >
        {' '}
        {showA && <Notification message={message} />}
      </div>
                ...
                <div className='logins__tabs-content w-tab-content'>
                  ...
                  >
                    <div className='logins__form-module w-form'>
                      <form id='email-form' className='logins__form'>
                        <div className='logins__inputs-wrapper'>
                          <div className='input'>
                            <label
                              htmlFor='email-2'
                              className='input__label text-light-emphasis'
                            >
                              Email
                            </label>
                            <input
                          ...
                          {showCodeInput && (
                            <div className='input'>
                              ...
                              />
                              <div className='input__hint fs-6 pt-2'>
                                Enter the 6-digit login code we just sent to
                                your inbox.{' '}
                              </div>
                            </div>
                          )}
