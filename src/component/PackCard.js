...
function PackCard() {
  return (
    <>
      <div
        className='bg-white mb-3 shadow  p-4'
        style={{ border: 'none', borderRadius: '15px', width: '97%' }}
        key={'sak'}
      >
        ...
        <CardBody>
          ...
          <div>
            <h4
              className='pt-3 text-light-emphasis fw-600'
              style={{ lineHeight: '1.5' }}
            >
              Ultimate ChatGPT Web Development Prompt Pack 💻
            </h4>
          </div>
          <div>
            <p className=' text-light-emphasis pt-3 fs-5'>
              Set up, design & overview websites easier than ever with web
              developer prompts
            </p>
          </div>
          <div>
        ...
        <div className='mt-4'>
          ...
          <span className='fs-6 mx-2'>999+ top-tier prompts</span>
        </div>
        <div className='mt-3'>
          <svg
            xmlns='http://www.w3.org/2000/svg'
          ...
          <span className='fs-6 mx-2'>199+ tasks to automate</span>
        </div>
        <div className='mt-3 d-flex'>
          ...
          <span className='fs-6 mx-2'>14-days money-back guarantee</span>
        </div>
      </div>
    </>
  );
