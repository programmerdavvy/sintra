    ...
    <>
      ...
      >
        ...
        <CardBody>
          ...
          <div>
            <p className=' text-light-emphasis pt-3 fs-5'>
              Using keyword research tools, this bot writes entire blog posts
              based on top searched keywords, and posts automatically to your
              website
            </p>
          </div>
          <div>
        ...
        <div className='mt-3'>
          ...
          <span className='fs-6 mx-2'>Runs on autopilot using ChatGPT</span>
        </div>
        <div className='mt-3 d-flex'>
          ...
          <span className='fs-6 mx-2'>Fully customizable and adjustable</span>
        </div>
      </div>
    </>
  );
